...
export function KernelZoomShowcaseUpscale() {
  ...
  return (
    <section className="py-10 md:py-16 bg-[#f3f1ed] dark:bg-neutral-950/20 border-y border-neutral-100 dark:border-neutral-900 overflow-hidden relative" id="kernel-zoom-section-upscale">
      <style>{`
