...
export function LinkedinSlideshow() {
  ...
  return (
    <section className="py-20 bg-[#FFFFFF] dark:bg-neutral-950/20 border-y border-neutral-100 dark:border-neutral-900 overflow-hidden relative" id="community-feed">
