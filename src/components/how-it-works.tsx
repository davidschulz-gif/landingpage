...
const HowItWorksWithoutOptimization: React.FC = () => {
    ...
    return (
        <section className="py-16 md:py-20 bg-[#F2F1ED] relative overflow-hidden ">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    <div className="order-1 lg:order-2 relative">
                        ...
                        <div className="absolute -top-10 -left-10 z-20 w-80 bg-white rounded-3xl p-6 shadow-2xl border border-gray-100 hidden md:block animate-in zoom-in-95 slide-in-from-top-4 duration-700 delay-300">
                            ...
                            <PromptTypewriter text={fullText} />
                        </div>
...
export const HowItWorks = React.memo(HowItWorksWithoutOptimization);
