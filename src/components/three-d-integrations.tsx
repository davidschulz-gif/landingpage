...
const renderLogo = (hasLogo: string) => {
  switch (hasLogo) {
    case 'acc':
      return (
        <svg viewBox="0 0 24 24" className="w-8 h-8 fill-current text-black dark:text-white">
    ...
    case 'grasshopper':
      return (
        <svg viewBox="0 0 24 24" className="w-8 h-8" fill="none" stroke="#2E7D32" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    case 'tekla':
      return (
        <svg viewBox="0 0 24 24" className="w-8 h-8" fill="none" stroke="#005A9C" strokeWidth="2">
    ...
    case 'snowflake':
      return (
        <svg viewBox="0 0 24 24" className="w-8 h-8" fill="none" stroke="#29B6F6" strokeWidth="2">
...
const IntegrationCard = ({
  ...
  return (
    <motion.div
      ...
      className="relative flex flex-col h-full bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 p-8 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300 group overflow-hidden"
    >
      ...
      <div className="flex justify-between items-start mb-6 relative z-10">
        ...
        {badge && (
          <span className="bg-black dark:bg-white text-white dark:text-black text-[9px] font-extrabold tracking-widest px-2.5 py-1 rounded-full uppercase scale-90 origin-top-right">
            {badge}
          </span>
        )}
      </div>
      ...
      {/* Title */}
      <h3 className="subheading-primary mb-2.5 flex items-center gap-1.5 relative z-10 dark:text-white font-sans ">
        {title}
        {infoIcon && (
      ...
      {/* Description */}
      <p className="text-neutral-500 dark:text-neutral-400 text-sm leading-relaxed font-sans font-medium flex-grow relative z-10">
        {description}
      </p>
    </motion.div>
  )
...
export const ThreeDIntegrations = () => {
  ...
  return (
    <section className="py-24 px-6 relative overflow-hidden bg-[#FDFDFD] dark:bg-neutral-950/20 border-y border-neutral-100 dark:border-neutral-900">
      {/* Grid Background */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Benefits Section */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16 pb-16 border-b border-neutral-100 dark:border-neutral-900">
          {benefits.map((benefit) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 bg-neutral-50 dark:bg-neutral-900 text-black dark:text-white rounded-xl flex items-center justify-center mb-5 border border-neutral-100/50 dark:border-neutral-800/50">
                  <Icon className="w-5 h-5" />
                </div>
                <h3 className="subheading-primary mb-2.5 dark:text-white font-sans ">
                  {t(`benefits.${benefit.key}.title`)}
                </h3>
                <p className="text-neutral-500 dark:text-neutral-400 text-sm leading-relaxed font-sans font-medium">
