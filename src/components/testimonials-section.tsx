...
export function TestimonialsSection() {
    ...
    return (
        <div className="w-full max-w-[100vw] overflow-hidden py-16">
            <style>{`
                @keyframes marquee {
            ...
            `}</style>
            <div className="w-full overflow-hidden mask-horizontal pb-4">
                <div className="animate-marquee gap-4 px-4 items-stretch">
                    {[...testimonials, ...testimonials].map((item, index) => (
                        <a 
                            ...
                            key={`${item.key}-${index}`}
                            className="bg-white dark:bg-neutral-950/40 border-2 border-black dark:border-neutral-800 rounded-none p-5 lg:p-4 relative flex flex-col transition-all duration-300 hover:-translate-y-1 w-[320px] lg:w-[280px] shrink-0 whitespace-normal block" 
                            style={{
                        ...
                        >
                            ...
                            <div className="flex items-start space-x-3 lg:space-x-2 mb-6">
                                ...
                                <div className="flex-1 pr-8 lg:pr-6 min-w-0">
                                    <div className="hover:underline inline-block max-w-full">
                            ...
                            <div className="text-gray-900 dark:text-neutral-100 text-sm lg:text-xs font-medium mb-6 leading-relaxed flex-grow italic">
                                "{t(`${item.key}.content`)}"
                            </div>
