    ...
    const testimonials: TestimonialData[] = [
        ...
        },
        {
        ...
        },
         {
            ...
            // imageUrl: '/typus_logo_black_transparent.png',
            initials: 'WA',
        ...
        <div className="w-full max-w-7xl mx-auto px-4 py-16">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
                {testimonials.map((item) => (
                    <div 
                        key={item.key}
                        className="bg-white dark:bg-neutral-950/40 border-2 border-black dark:border-neutral-800 rounded-none p-6 relative flex flex-col transition-all duration-300 hover:-translate-y-1" 
                        style={{
                    ...
                    >
                        ...
                        <div className="flex items-start space-x-4 mb-6">
                            <div className="relative w-14 h-14 flex-shrink-0">
                                {item.imageUrl ? (
                                    ...
                                    <div className={`w-full h-full rounded-full bg-gradient-to-br ${item.gradientClass} flex items-center justify-center text-white font-bold text-base tracking-wider border border-neutral-800/10 shadow-inner`}>
                                        {item.initials}
                                    </div>
                                )}
                            </div>
                            <div className="flex-1 pr-6 min-w-0">
                                ...
                                >
                                    <h3 className="font-bold text-gray-900 dark:text-neutral-100 text-base mb-0.5 truncate">
                                        {t(`${item.key}.name`)}
                                    </h3>
                                </a>
                        ...
                        <p className="text-gray-900 dark:text-neutral-100 text-sm font-medium mb-6 leading-relaxed flex-grow italic">
                            "{t(`${item.key}.content`)}"
                        </p>
