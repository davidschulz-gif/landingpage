...
const ALL_IMAGES = [
  ...
  { src: 'https://prai-vision.s3.eu-central-1.amazonaws.com/templates/modern-coastal-green-facade.jpg', mobile: false, desktop: { width: 300, height: 175, x: 300, y: 25, rotate: 5, delay: 0.15 } },
