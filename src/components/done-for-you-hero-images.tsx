...
const ALL_IMAGES = [
  ...
  { src: '/variation-10.jpg', mobile: false, desktop: { width: 380, height: 260, x: 250, y: -420, rotate: 4, delay: 0.3 } },

  // Left Cluster
  { src: '/variation-3.jpg', mobile: false, desktop: { width: 300, height: 210, x: -650, y: -150, rotate: -8, delay: 0.2 } },
  { src: '/variation-4.jpg', mobile: false, desktop: { width: 375, height: 250, x: -750, y: 50, rotate: 6, delay: 0.4 } },
  { src: '/variation-7.jpg', mobile: false, desktop: { width: 250, height: 175, x: -600, y: 250, rotate: -4, delay: 0.1 } },

  // Right Cluster
  { src: '/variation-8.jpg', mobile: false, desktop: { width: 280, height: 200, x: 400, y: -100, rotate: 5, delay: 0.5 } },
  ...
  { src: '/variation-1.jpg', mobile: false, desktop: { width: 300, height: 240, x: -650, y: -380, rotate: 10, delay: 0.8 } },
