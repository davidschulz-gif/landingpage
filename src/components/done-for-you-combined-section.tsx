...
export const DoneForYouCombinedSection = () => {
  ...
  return (
    <section className='relative w-full overflow-hidden py-24 lg:py-32 my-10 border-y border-neutral-100 dark:border-neutral-800' style={{ backgroundColor: '#FFFFFF' }}>
