        ...
        <section className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 font-normal'>
          ...
          <div className='relative bg-white dark:bg-neutral-900 rounded-3xl border border-neutral-200/90 dark:border-neutral-800 p-6 sm:p-8 shadow-sm overflow-hidden'>
            ...
            <div className='relative p-6 rounded-2xl bg-neutral-50 dark:bg-neutral-800/60 border border-neutral-200 dark:border-neutral-700 text-neutral-900 dark:text-white overflow-hidden'>
              ...
              <p className='text-xs text-neutral-500 dark:text-neutral-400 mt-4 border-t border-neutral-200 dark:border-neutral-700 pt-3 font-normal'>
          ...
          >
            ...
            {/* Compensation Rate Card (styled without black fill) */}
            <div className='relative p-5 sm:p-6 rounded-2xl bg-neutral-50 dark:bg-neutral-800/60 border border-neutral-200 dark:border-neutral-700 mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 overflow-hidden'>
              <CornerSquares size='w-1.5 h-1.5' />
              <div>
                ...
                <span className='text-2xl sm:text-3xl font-bold text-neutral-950 dark:text-white'>USD 20</span>
                <span className='text-neutral-600 dark:text-neutral-400 text-sm ml-2 font-normal'>
                  {t('clauses.section4RateSub')}
                </span>
              </div>
              <div className='sm:text-right border-t sm:border-t-0 sm:border-l border-neutral-200 dark:border-neutral-700 pt-3 sm:pt-0 sm:pl-6'>
                <span className='text-xs uppercase text-neutral-500 dark:text-neutral-400 font-bold tracking-wider block'>
          ...
          <div className='relative bg-white dark:bg-neutral-900 rounded-3xl border border-neutral-200/90 dark:border-neutral-800 p-6 sm:p-8 shadow-sm overflow-hidden'>
            ...
            <div className='relative p-5 sm:p-6 rounded-2xl bg-neutral-50 dark:bg-neutral-800/60 border border-neutral-200 dark:border-neutral-700 mb-4 overflow-hidden'>
              ...
              <pre className='font-mono text-xs sm:text-sm text-neutral-800 dark:text-neutral-200 whitespace-pre-wrap leading-relaxed font-normal'>
