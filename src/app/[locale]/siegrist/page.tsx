        ...
        <div className='relative w-full bg-[#FFFFFF] dark:bg-neutral-950 min-h-screen flex flex-col justify-between overflow-x-hidden selection:bg-black selection:text-white'>
            <div>
                ...
                <main className="pt-20">
                    ...
                    {/* Upscale Section – full content from /upscale */}

                    {/* 1. Hero Block & Intro Paragraphs */}
                    <div className="pt-16 pb-10 px-4 max-w-5xl mx-auto border-t border-neutral-100 dark:border-neutral-900 mt-8">
                        <motion.div
                        ...
                        >
                            ...
                            {/* Main Title */}
                            <h2 className="text-3xl sm:text-4xl md:text-[46px] font-normal text-black dark:text-white tracking-tight leading-[1.05]" style={{ fontFamily: 'Arial' }}>
                                {locale === 'de'
                    ...
                    <div className="py-12 border-t border-neutral-100 dark:border-neutral-900 px-4 max-w-5xl mx-auto">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
                            <div className="space-y-4">
                                <h2 className="text-2xl font-normal text-black dark:text-white tracking-tight leading-snug" style={{ fontFamily: 'Arial' }}>
                                    {locale === 'de'
