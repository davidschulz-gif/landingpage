      ...
      <div>
        ...
        {isClient && isMobile ? (
          ...
          <>
            ...
            <div className="w-full bg-[#FFFFFF] dark:bg-neutral-950/20 py-4 border-t border-b border-neutral-100 dark:border-neutral-900">
              {isClient && <KernelZoomShowcaseUpscale />}
            </div>

            {/* Thumbnails to access sliders */}
            <div className="w-full bg-[#FFFFFF] dark:bg-neutral-950/20 py-8 border-b border-neutral-100 dark:border-neutral-900">
