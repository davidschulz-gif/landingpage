    ...
    <div className="research-page-scope relative w-full bg-[#FFFFFF] dark:bg-neutral-950 text-neutral-900 dark:text-white min-h-screen font-sans selection:bg-black selection:text-white">
            ...
            <div className="relative p-6 sm:p-10 rounded-2xl bg-white border border-neutral-200 shadow-2xs">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                <div className="space-y-4 max-w-2xl text-left">
                  <div className="flex items-center gap-2.5 flex-wrap">
                    ...
                    <span className="text-xs font-semibold text-neutral-500">
                      {tProvider('configuratorSection.price')}
                    </span>
                  </div>
                  ...
                  <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed" style={{ fontFamily: 'Arial' }}>
                    {tProvider('configuratorSection.subtitle')}
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                    <div className="flex items-start gap-2.5 text-xs text-neutral-700">
                      ...
                      <span>{tProvider('configuratorSection.feature1')}</span>
                    </div>
                    <div className="flex items-start gap-2.5 text-xs text-neutral-700">
                      <CheckCircle2 size={16} className="text-neutral-900 shrink-0 mt-0.5" />
                      <span>{tProvider('configuratorSection.feature2')}</span>
                    </div>
                    <div className="flex items-start gap-2.5 text-xs text-neutral-700">
                      <CheckCircle2 size={16} className="text-neutral-900 shrink-0 mt-0.5" />
                      <span>{tProvider('configuratorSection.feature3')}</span>
                    </div>
                    <div className="flex items-start gap-2.5 text-xs text-neutral-700">
                      <CheckCircle2 size={16} className="text-neutral-900 shrink-0 mt-0.5" />
                      <span>{tProvider('configuratorSection.feature4')}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row lg:flex-col items-stretch gap-3 shrink-0">
                  ...
                  >
                    <span>{tProvider('configuratorSection.ctaRequest')}</span>
                    <ArrowRight size={14} />
                  </Link>
                  <a
                    href="https://calendar.app.google/q85ip5B1L6vwHs1w7"
                  ...
                  >
                    <span>{tProvider('configuratorSection.ctaDemo')}</span>
      ...
      {isContactModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 animate-in fade-in">
          <div className="relative w-full max-w-lg bg-white rounded-3xl p-7 shadow-2xl border border-slate-100 text-black">
            <button
              onClick={() => {
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-600 mt-1">
                    {tProvider('landingModal.subtitle')}
                  </p>
                </div>
                <form
                  onSubmit={(e) => {
                ...
                >
                  <div>
                    <label className="block text-xs font-semibold text-slate-700 mb-1">
                      {tProvider('landingModal.company')}
                    </label>
                    <input
                      type="text"
                      required
                      placeholder={tProvider('landingModal.companyPlaceholder')}
                      className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm focus:outline-hidden focus:border-slate-900"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-slate-700 mb-1">
                      {tProvider('landingModal.email')}
                    </label>
                    <input
                      type="email"
                      required
                      placeholder={tProvider('landingModal.emailPlaceholder')}
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-neutral-700 mb-1">
                      {tProvider('landingModal.message')}
                    </label>
                    <textarea
                      rows={3}
                      placeholder={tProvider('landingModal.messagePlaceholder')}
                  ...
                  >
                    {tProvider('landingModal.submitBtn')}
                  </button>
                </form>
              </div>
            )}
