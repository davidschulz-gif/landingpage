...
export function NavbarDemo() {
  ...
  return (
    <Navbar>
      ...
      <div
        ref={menuRef}
        className={`fixed left-0 right-0 w-full bg-white/95 pt-20 backdrop-blur-2xl border-b border-gray-200/60 shadow-2xl shadow-black/10 z-[0] transition-all duration-300 ease-[cubic-bezier(0.4,0.0,0.2,1)] ${
          isMenuOpen
