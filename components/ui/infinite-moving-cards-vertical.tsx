...
export const InfiniteMovingCardsVertical = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20 h-full overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white_20%,white_80%,transparent)]",
        className
      )}
    >
      <ul
        ref={scrollerRef}
        className={cn(
          "flex min-h-full shrink-0 gap-4 py-4 flex-col",
